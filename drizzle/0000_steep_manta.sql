CREATE TYPE "public"."status" AS ENUM('pending', 'paid', 'failed', 'refunded');--> statement-breakpoint
...
CREATE TABLE "payments" (
	...
	"provider_signature" uuid NOT NULL,
	"status" "status" DEFAULT 'pending' NOT NULL,
	...
	CONSTRAINT "payments_provider_signature_unique" UNIQUE("provider_signature")
);
--> statement-breakpoint
