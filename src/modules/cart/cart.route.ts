...
router.post("/add", authMiddleware, validateBody(cartSchema), asyncHandler(addToCart));
router.put("/update/:id", authMiddleware, validateBody(cartSchema), asyncHandler(updateCart));
